...
ipython notebook --profile=narrative --NotebookApp.base_project_url="/narrative/$1" --NotebookApp.base_kernel_url="/narrative/$1" --NotebookApp.open_browser="False" --ip="*" --log-level=DEBUG
