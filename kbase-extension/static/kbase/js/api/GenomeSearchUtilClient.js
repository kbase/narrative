...
function GenomeSearchUtil(
    ...
    if (!this.service_version) this.service_version = 'release';
    ...
    this.search = function (params, _callback, _errorCallback) {
        ...
        if (this.use_url_lookup) {
            json_call_ajax(
                ...
                [{ module_name: 'GenomeSearchUtil', version: self.service_version }],
                1,
