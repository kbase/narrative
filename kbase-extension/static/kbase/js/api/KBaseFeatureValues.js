function KBaseFeatureValues(url, auth, auth_cb) {
    ...
    this.status = function (_callback, _errorCallback) {
        return json_call_ajax('KBaseFeatureValues.status', [], 1, _callback, _errorCallback);
    };
    ...
    this.get_matrix_descriptor_async = function (
        GetMatrixDescriptorParams,
        _callback,
        _error_callback
    ) {
    ...
    this.get_matrix_row_descriptors = function (
    ...
    this.get_matrix_row_descriptors_async = function (
        GetMatrixItemDescriptorsParams,
        _callback,
        _error_callback
    ) {
    ...
    this.get_matrix_column_descriptors = function (
        GetMatrixItemDescriptorsParams,
        _callback,
        _errorCallback
    ) {
    ...
    this.get_matrix_column_descriptors_async = function (
        GetMatrixItemDescriptorsParams,
        _callback,
        _error_callback
    ) {
    ...
    this.get_matrix_rows_stat_async = function (
        GetMatrixItemsStatParams,
        _callback,
        _error_callback
    ) {
    ...
    this.get_matrix_columns_stat_async = function (
        GetMatrixItemsStatParams,
        _callback,
        _error_callback
    ) {
    ...
    this.get_matrix_row_sets_stat_async = function (
        GetMatrixSetsStatParams,
        _callback,
        _error_callback
    ) {
    ...
    this.get_matrix_column_sets_stat = function (
        GetMatrixSetsStatParams,
        _callback,
        _errorCallback
    ) {
    ...
    this.get_matrix_column_sets_stat_async = function (
        GetMatrixSetsStatParams,
        _callback,
        _error_callback
    ) {
