...
function ExpressionServices(url, auth) {
    ...
    this.get_expression_samples_data = function (sampleIds) {
        const resp = json_call_ajax_sync('ExpressionServices.get_expression_samples_data', [
            sampleIds,
        ]);
        return resp[0];
    };
    ...
    this.get_expression_samples_data_by_series_ids = function (seriesIds) {
        const resp = json_call_ajax_sync(
    ...
    this.get_expression_data_by_feature_ids = function (featureIds, sampleType, wildTypeOnly) {
        const resp = json_call_ajax_sync('ExpressionServices.get_expression_data_by_feature_ids', [
            featureIds,
            sampleType,
            wildTypeOnly,
        ]);
