define(['bluebird', 'kb_common/jsonRpc/genericClient'], function (Promise, ServiceClient) {
    'use strict';
    ...
    function factory(config) {
        ...
        function referenceGenomeTotal(arg) {
            ...
            return searchApi.callFunc('search_types', [param]).spread(function (result) {
                return result;
            });
        }
        ...
        function referenceGenomeDataSearch(arg) {
            ...
            return searchApi.callFunc('search_objects', [param]).spread(function (result) {
                return result;
            });
        }

        function referenceGenomeSearch(arg) {
            return Promise.all([referenceGenomeTotal(arg), referenceGenomeDataSearch(arg)]).spread(
                function (total, data) {
                    return {
