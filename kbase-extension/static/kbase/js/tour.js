        ...
        this.tour_steps = [
            {
                ...
                orphan: true,
                content:
                    '<p>This tour will demonstrate how to use KBase’s Narrative User Interface to begin creating Narratives for data analysis. Think of a Narrative as an advanced lab notebook that contains all of your data, analyses, notes, visualizations, custom scripts, and results.<p>Use the left and right arrow buttons to go backwards and forwards through this tour.',
                backdrop: true,
            },
            {
                ...
                placement: 'bottom',
                content:
                    'By default, each new Narrative is named “Untitled.” Click on this name and enter a new title.',
            },
            {
                ...
                placement: 'bottom',
                content:
                    'If you have edit permission for this Narrative, you can choose View Only (uneditable) or Edit mode',
            },
            {
            ...
            },
            {
                ...
                placement: 'bottom',
                content:
                    'You should periodically save your Narrative by clicking the save button. KBase does autosave your Narrative whenever an App is run, but other changes should be saved manually.',
            },
            {
                ...
                placement: 'left',
                content:
                    'Click here for a menu that will let you view and edit your user profile or log out.',
            },
            {
            ...
            },
            {
                ...
                placement: 'left',
                content:
                    'Code Cells allow you to use Python and other coding languages to create custom scripts in your Narrative.',
            },
            {
                title: 'End of Advanced Features Tour',
                orphan: true,
                content:
                    'You have now been introduced to the advanced features of the Narrative Interface. The <a href="https://docs.kbase.us/getting-started/narrative">Narrative User Guide</a> has more information. If you have any questions or feature requests, please follow the Contact Us link in the help menu.',
                backdrop: true,
            },
        ];
