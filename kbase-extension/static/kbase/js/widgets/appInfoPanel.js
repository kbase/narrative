...
], function (Promise, Runtime, Catalog, NarrativeMethodStore, Handlebars, appInfoPanelTmpl) {
    'use strict';
        ...
        function start(arg) {
            return Promise.try(function () {
                ...
                var infoProms = [
                    ...
                    nms
                        .get_method_full_info({ ids: [appId], tag: tag })
                    ...
                    catalog
                        .get_exec_aggr_stats({ full_app_ids: [appId] })
                    ...
                    catalog.get_module_info({ module_name: appModule }).then(function (moduleInfo) {
