define(['bluebird', 'kb_service/client/workspace', 'kb_service/utils'], function (
    Promise,
    Workspace,
    serviceUtils
) {
    ...
    function Validators() {
        ...
        function validateSet(value, options) {
            ...
            if (value === undefined) {
                ...
                if (
                    !options.values.some(function (setValue) {
        ...
        function validateWorkspaceObjectNameRef(value, options) {
            var parsedValue, errorMessage, diagnosis;
        ...
        function validateTextSet(set, options) {
            var errorMessage, diagnosis, parsedSet;
            // values are raw, no parsing.
