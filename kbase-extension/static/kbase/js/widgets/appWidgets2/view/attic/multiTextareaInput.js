...
define([
    ...
    'bootstrap',
    'css!font-awesome'
], function (Promise, Jupyter, html, Validation, Events, Dom, Runtime, SingleTextareaInputWidget) {
    'use strict';
    ...
    function factory(config) {
        ...
        function setModelValue(value, index) {
            return Promise.try(function () {
                console.log('SETTING MODEL VALUE', value, index);
                if (index !== undefined) {
                    if (value) {
        ...
        function addModelValue(value) {
            return Promise.try(function () {
                console.log('adding model value', value);
        ...
        function makeSingleInputControl(currentValue, index, events, bus) {
            ...
            var preButton, postButton,
                ...
                inputWidget = SingleTextareaInputWidget.make({
                    bus: inputBus,
            ...
            inputBus.on('validation', function (message) {
                if (message.diagnosis === 'optional-empty') {
                    ...
                    // alert('delete me!');
// TODO: i don't know what i was trying to accomplish here...                    
//                    console.log('validation', model.value);
