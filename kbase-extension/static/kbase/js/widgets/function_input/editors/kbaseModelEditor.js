...
define([
    ...
    return KBWidget({
        ...
        init: function (input) {
            ...
            var saveBtn = $('<button class="btn btn-primary btn-save hide">' + 'Save</button>');
            ...
            // get media data
            container.loading();
            api('ws', 'get_objects', [param]).done(function (res) {
            ...
            */
            ...
            function rxnModal() {
                ...
                var table = table.DataTable({
                    ...
                    ajax: function (opts, callback, settings) {
                        biochem('reactions', opts, ['id', 'name', 'definition']).done(function (
                            res
                        ) {
                            if (res) {
                                var data = {
            ...
            function saveData(master, ws, name) {
                ...
                if (rxnsToAdd.length && rxnsToRemove.length) {
                    prom = addReactions(ws, name, rxnsToAdd).then(function () {
