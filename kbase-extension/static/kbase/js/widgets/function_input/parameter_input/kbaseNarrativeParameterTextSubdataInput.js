...
define([
    ...
    'select2',
], function (KBWidget, bootstrap, $, Config, Handlebars, kbaseNarrativeParameterInput, select2) {
    'use strict';
    return KBWidget({
        ...
        fetchSubData: function (doneCallback) {
            ...
            // otherwise we have to look at a parameter value to populate the list
                ...
                var param = self.options.kbaseMethodInputWidget.getParameterValue(
                ...
                if (param) {
                    ...
                    self.isFetching = true;
                    self.trigger('workspaceQuery.Narrative', function (ws_name) {
                        var query = [];
