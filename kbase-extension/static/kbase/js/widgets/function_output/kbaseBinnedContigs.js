        ...
        showBinList: function () {
            ...
            new DynamicTable($content, {
                ...
                rowFunction: function ($row, rowValues) {
                    var $listBtn = Display.simpleButton('btn-xs', 'fa fa-list').click(function () {
                        self.showBinTab(rowValues[0]);
                    });
                    var $plotBtn = Display.simpleButton('btn-xs', 'fa fa-bar-chart').click(
                        function () {
            ...
            Promise.resolve(
                ...
                .then(
                    function (results) {
                        ...
                        var gd3 = d3.select($content.get(0)).style({
