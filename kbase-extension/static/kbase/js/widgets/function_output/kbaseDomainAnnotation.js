...
define([
    ...
    return KBWidget({
        ...
        render: function () {
            ...
            const domainAnnotationRef = self.buildObjectIdentity(
                this.options.workspaceID,
                this.options.domainAnnotationID,
                this.options.domainAnnotationVer
            );
            kbws.get_objects([domainAnnotationRef], (data) => {
                ...
                const jobGetDomainModelSet = kbws.get_objects(
                    ...
                    (data) => {
                        self.accessionToShortDescription =
                            data[0].data.domain_accession_to_description;
                        ...
                        $.each(self.accessionToShortDescription, (domainID, description) => {
                            ...
                            if (description.length > self.options.maxDescriptionLength) {
                                const pos = description.indexOf(
                                    ' ',
                                    self.options.maxDescriptionLength
                                );
                                if (pos > -1) {
                                    self.accessionToLongDescription[domainID] =
                                        description +
                                        ' <small><a class="show-less' +
                                        self.pref +
                                        '" data-id="' +
                                        domainID +
                                        '">show&nbsp;less</a></small>';
                                    self.accessionToShortDescription[domainID] =
                                        description.substring(0, pos) +
                                        ' <small><a class="show-more' +
                                        self.pref +
                                        '" data-id="' +
                                        domainID +
                                        '">more&#8230;</a></small>';
                ...
                $.when
                    .apply($, [jobGetDomainAnnotationProperties, jobGetDomainModelSet])
                    .done(() => {
                        self.loading(false);
                        self.prepareVizData();
                        ...
                        tableOver
                            .append(
                                self.makeRow(
                                    'Annotated genome',
                                    $('<span />')
                                        .append(self.genomeName)
                                        .css('font-style', 'italic')
                                )
                            )
                            .append(self.makeRow('Domain model set', self.domainModelSetName))
                            .append(self.makeRow('Annotated genes', self.annotatedGenesCount))
                            .append(self.makeRow('Annotated domains', self.annotatedDomainsCount));
                        ...
                        const domainTableSettings = {
                            ...
                            aoColumns: [
                                ...
                                {
                                    sTitle: 'LongDescription',
                                    mData: 'longDomainDescription',
                                    bVisible: false,
                                    bSearchable: true,
                                },
                                ...
                                for (const domainID in domainsInfo) {
                                    ...
                                    for (let i = 0; i < domainsArray.length; i++) {
                                        ...
                                        const domainImgWidth =
                                            ((domainEnd - domainStart) * 100) / geneLength;
                        ...
                        function eventsMoreDescription() {
                            ...
                            $('.show-more' + self.pref).click(function () {
                                ...
                                $(this)
                                    .closest('td')
                                    .html(self.accessionToLongDescription[domainID]);
                        ...
                        function eventsLessDescription() {
                            ...
                            $('.show-less' + self.pref).click(function () {
                                ...
                                $(this)
                                    .closest('td')
                                    .html(self.accessionToShortDescription[domainID]);
                                eventsMoreDescription();
                            });
                        }
                    });
