...
define([
...
], (Uuid, $, KBWidget, kbaseAuthenticatedWidget, kbaseTabs, Config, GenericClient, Promise) => {
    'use strict';
    ...
    return KBWidget({
        ...
        loadAndRender: function () {
            ...
            const get_matrix_stat_promise = self.genericClient.sync_call(
            ...
            // service goes down.
            const enhancedFilter_promise = self.genericClient.sync_call(
            ...
            tableOver
                .append(
                    self.makeRow(
                        'Genome',
                        $('<span />')
                            .append(matrixStat.mtx_descriptor.genome_name)
                ...
                .append(
                    self.makeRow('Row normalization', matrixStat.mtx_descriptor.row_normalization)
                )
                .append(
                    self.makeRow(
            ...
            */
            ...
            for (var i = 0; i < enhancedFeatures.values.length; i++) {
                ...
                tableData.push({
                    ...
                    is_missing_values:
                        enhancedFeatures.values[i][key_to_idx_map['is_missing_values']],
