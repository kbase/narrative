            ...
            Promise.resolve(kbws.get_objects(get_object_input))
                .then((data) => {
                    ...
                    if (modelComp.pangenome_ref) {
                        tableStats.append(
                            '<tr><td>Pangenome</td><td>' + modelComp.pangenome_ref + '</td></tr>'
                        );
                    }
                    ...
                    for (var i = 0; i < modelComp.reactions.length; i++) {
                        for (var j = 0; j < modelComp.models.length; j++) {
                            ...
                            if (
                                modelComp.reactions[i].reaction_model_data.hasOwnProperty(model_id)
                            ) {
                                if (
                                    ...
                                    modelComp.reactions[i].reaction_model_data[model_id][0] === 1
                                ) {
                    ...
                    for (var i = 0; i < modelComp.compounds.length; i++) {
                        for (var j = 0; j < modelComp.models.length; j++) {
                            var model_id = modelComp.models[j].id;
                            if (
                                modelComp.compounds[i].model_compound_compartments.hasOwnProperty(
                                    model_id
                                )
                            ) {
                                if (
