...
define([
    ...
    return KBWidget({
        ...
        appendUI: function ($elem) {
            ...
            $.when(
                ...
                .then(function (d, info) {
                    ...
                    $.each($self.summary.annotation.feature_type_counts, function (k, v) {
        ...
        showGeneContent: function ($tab) {
            ...
            var $selector = $.jqElem('select').on('change', function () {
            ...
            if (this.content[type] == undefined) {
                ...
                $self.genome_api
                    ...
                    .then(function (features) {
                        ...
                        $.each(features, function (feature_id, feature) {
                            ...
                            if (feature.feature_aliases != undefined) {
                                $.each(feature.feature_aliases, function (alias, sources) {
                                    aliases.push(
                                        '<span title="' +
                                            sources.join(',') +
                                            '">' +
                            ...
                            if (feature.feature_locations != undefined) {
                                $.each(feature.feature_locations, function (i, contig) {
