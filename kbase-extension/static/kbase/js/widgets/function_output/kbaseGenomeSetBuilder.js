...
define([
    ...
    'kbasePrompt',
], function (KBWidget, bootstrap, $, Config, kbaseAuthenticatedWidget, kbasePrompt) {
    return KBWidget({
        ...
        size: function (obj) {
            var size = 0;
            for (var key in obj) if (obj.hasOwnProperty(key) && key.indexOf('param') == 0) size++;
            return size;
        },
