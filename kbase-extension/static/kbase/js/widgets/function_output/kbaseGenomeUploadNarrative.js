        ...
        render: function () {
            ...
            var panel = $(
                '<div>' +
                    ...
                    'form" action="' +
                    self.uploadUrl +
                    '" enctype="multipart/form-data" method="post" target="' +
                    pref +
                    'hidden-iframe">' +
                    ...
                    self.genome_id +
                    '">' +
                    '<input type="hidden" name="type" value="genome' +
                    self.type +
                    '">' +
                    ...
                    'frm" name="' +
                    pref +
                    'hidden-iframe" style="display: none; width:800px; height: 100px; overflow-x: scroll; overflow-y: scroll"></iframe>' +
                    '</div>'
            );
