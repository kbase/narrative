            ...
            kbws.get_objects(
                ...
                function (data) {
                    ...
                    if (data.length == 0) {
                        ...
                        var ann_aa_reads =
                            ann_reads && ann_reads > ann_rna_reads ? ann_reads - ann_rna_reads : 0;
                        var unkn_aa_reads = aa_reads - ann_aa_reads;
                        var unknown_all =
                            raw_seqs -
                            (qc_fail_seqs + unkn_aa_reads + ann_aa_reads + ann_rna_reads);
                        ...
                        var html = '<h4>Info</h4>';
                        html +=
                            '<p><table class="table table-striped table-bordered" style="width: 50%;">';
                        html +=
                        ...
                        html =
                            '<p><table class="table table-striped table-bordered" style="width: 65%;">';
                        html +=
                        ...
                        if (
                            ...
                            drisee_cols &&
                            drisee_data &&
                            drisee_cols.length > 0 &&
                            drisee_data.length > 0
                        ) {
                            ...
                            for (var i = 0; i < y.length; i++) {
                                ...
                                for (var j = 0; j < drisee_data.length; j++) {
                                    xy.push({
                                        x: parseFloat(drisee_data[j][x]),
                                        y: parseFloat(drisee_data[j][y[i]]),
                                    });
                            ...
                            var height =
                                lheight > pheight
                                    ? Math.min(lheight, pheight + pheight / 2)
                                    : pheight;
                        ...
                        if (!is_rna && kmer_data && kmer_data.length > 0) {
                            ...
                            for (var i = 0; i < kmer_data.length; i += 2) {
                                xy.push({
                                    x: parseFloat(kmer_data[i][3]),
                                    y: parseFloat(kmer_data[i][0]),
                                });
                        ...
                        var width = pwidth + lwidth;
                        var height =
                            lheight > pheight ? Math.min(lheight, pheight + pheight / 2) : pheight;
