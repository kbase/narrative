...
define(['kbwidget', 'bootstrap', 'jquery', 'kbaseAuthenticatedWidget', 'catalog-client-api'], (
    KBWidget,
    bootstrap,
    $,
    ...
    return KBWidget({
        ...
        loggedInCallback: function (event, auth) {
            ...
            if (!this.registration_id) {
                this.loading(false);
                this.showMessage(
                    'No registration_id provided or returned, so no build log can be shown.'
                );
            } else {
                this.render();
            }
        ...
        render: function () {
            ...
            self.$log_window = $(
                '<textarea style="width:100%;font-family:Monaco,monospace;font-size:9pt;color:#555;resize:vertical;" rows="20" readonly>'
            );
