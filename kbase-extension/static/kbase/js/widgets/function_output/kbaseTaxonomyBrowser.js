define([
    ...
    return KBWidget({
        ...
        init: function init(options) {
            ...
            this.genericClient
                ...
                .then(function (data) {
                    var lineage = [];
                    $self.lineage = {};
                    $.each(data[0].lineage_genomes, function (i, g) {
                        lineage.unshift({
        ...
        buildGenomesElem: function bunildGenomesElem(data) {
            ...
            var $self = this;
            var $containerElem = $.jqElem('table')
                .addClass('display')
        ...
        buildSelectorElem: function (data) {
            ...
            var $select =
                ...
                $.jqElem('select').on('change', function (e) {
                    $self.loadLineage($select.val());
                });
            $.each(data, function (i, line) {
                var $option = $.jqElem('option').attr('value', line.label).append(line.label);
