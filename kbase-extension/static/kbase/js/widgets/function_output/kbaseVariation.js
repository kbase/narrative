...
], function (KBWidget, bootstrap, $, Config, kbaseAuthenticatedWidget, DynamicServiceClient) {
    return KBWidget({
        name: 'kbaseVariation',
        ...
        getLinks: function () {
            ...
            return client.lookupModule().spread(function (status) {
                return status.url;
            });
        },
        ...
        render: function () {
            this.$elem.empty();
            this.getLinks().then((url) => this.buildIframe(url));
        },
