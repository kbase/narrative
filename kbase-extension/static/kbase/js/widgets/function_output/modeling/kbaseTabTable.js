...
define([
    ...
    return KBWidget({
        ...
        init: function (input) {
            ...
            self.kbapi('ws', 'get_objects', [param]).done(function (data) {
            ...
            function preProcessDataTable(tabSpec, tabPane) {
                ...
                return self
                    .kbapi('ws', 'get_object_info_new', { objects: refs })
                    .then(function (data) {
            ...
            this.getBiochemReaction = function (id) {
                ...
                return self
                    .kbapi('biochem', 'get_reactions', { reactions: [id] })
                    .then(function (data) {
                        return data[0];
                    });
            };
            ...
            this.getBiochemCompound = function (id) {
                return self
                    .kbapi('biochem', 'get_compounds', { compounds: [id] })
                    .then(function (data) {
                        return data[0];
                    });
            };
