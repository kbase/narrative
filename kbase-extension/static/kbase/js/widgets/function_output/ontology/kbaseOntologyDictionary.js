define([
    ...
    return KBWidget({
        ...
        init: function init(options) {
            ...
            $self.ws
                ...
                .then(function (data) {
                    ...
                    var typedef_data = [];
                    $.each(data.typedef_hash || {}, function (k, v) {
                    ...
                    $.each(data.term_hash, function (k, v) {
                        table_data.push([
                            v,
                    ...
                    $.each($self.colorMap, function (k, v) {
                        $self
                            .data('colorMapElem')
                            .append(
                                $.jqElem('span')
        ...
        getLineage: function (term_id, recursive, circular_breaker) {
            ...
            var parents = {};
            if (term.is_a) {
                $.each(this.parseISA(term.is_a), function (i, v) {
                    parents[v] = undefined;
                });
            } else {
                return undefined;
        ...
        reallyAppendTerm: function (term) {
            ...
            if (term.relationship_closure !== undefined) {
                ...
                for (var type in term.relationship_closure) {
                    ...
                    $.each(term.relationship_closure[type], function (i, elem) {
            ...
            if (term.relationship !== undefined) {
                $.each(term.relationship, function (i, rel) {
                    var parts = rel.split(/ ! /);
        ...
        appendUI: function appendUI($elem) {
            ...
            var $containerElem = $self.createContainerElem('Term Dictionary', [
                $tableElem,
                $colorMapElem,
            ]);
            ...
            var $typeDefElem = $self
                .data('typeDefElem', $.jqElem('table').addClass('display'))
                .css({ width: '100%', border: '1px solid #ddd' });

            var $typeDefContainerElem = $self
