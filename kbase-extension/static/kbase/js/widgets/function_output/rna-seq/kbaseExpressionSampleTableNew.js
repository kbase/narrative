    ...
    return KBWidget({
            ...
            ws.get_objects([ws_params])
                .then(function (d) {
                    ...
                    if (thing.sample_expression_ids) {
                        ...
                        var promises = [];
                        $.each($self.options.output.sample_expression_ids, function (i, v) {
                        ...
                        var promises = [];
                        $.each($self.options.output.items, function (i, v) {
        ...
        appendUI: function appendUI($elem) {
            ...
            if (this.options.output.sample_expression_ids) {
                ...
                $.each(this.options.output.sample_expression_ids, function (i, v) {
                    $selector.append(
                        $.jqElem('option')
                            .attr('value', v)
            ...
            var $tpmHistogram = new kbaseHistogram($tpmHistElem, {
                scaleAxes: true,
                xPadding: 60,
                yPadding: 120,
