define(['kbwidget', 'bootstrap', 'jquery', 'kbaseTable', 'kbaseAuthenticatedWidget'], function (
    KBWidget,
    bootstrap,
    $,
    kbaseTable,
    ...
    return KBWidget({
        ...
        loadAnalysis: function (ws, analysis) {
            ...
            if (analysis.alignments) {
                ...
                var alignment_ids = [];
                $.each(analysis.alignments, function (k, v) {
            ...
            if (analysis.expression_values) {
                ...
                var ev_ids = [];
                $.each(analysis.expression_values, function (k, v) {
                    if (external_ids[k] == undefined) {
                        ev_ids.push(k);
                        all_promises.push(ws.get_object_info([{ ref: k }]));
                        external_ids[k] = 1;
