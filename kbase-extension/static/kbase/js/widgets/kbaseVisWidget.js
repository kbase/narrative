...
define([
    ...
    return KBWidget({
        ...
        renderXAxis: function renderXAxis() {
            ...
            var xAxis = d3.svg.axis().scale(this.xScale()).orient(xAxisOrientation);
        ...
        renderYAxis: function renderYAxis() {
            ...
            var yAxis = d3.svg.axis().scale(this.yScale()).orient(this.options.yAxisOrientation);
