...
define([
    ...
    return KBWidget({
        ...
        renderControlToolbar: function () {
            ...
            // SEARCH
            var $searchBox = $('<input type="text" placeholder="Search" size="50">').addClass(
                'form-control'
            );
            $searchBox
                .on('input', function () {
        ...
        initMainPanel: function ($appListPanel, $moduleListPanel) {
            var $mainPanel = $('<div>').addClass('container').css({
                width: '100%',
                'overflow-x': 'hidden',
                height: '550px',
                'overflow-y': 'auto',
