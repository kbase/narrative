...
define(['jquery', 'kbwidget', 'base/js/namespace'], function ($, KBWidget, Jupyter) {
    'use strict';
    return KBWidget({
        ...
        renderCell: function (baseClass, panelClass, headerClass, $label, titleSuffix) {
            ...
            var $headerLabel = $('<span>').addClass('label label-info').append('Output');
