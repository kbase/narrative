...
define([
    ...
    'kbaseNarrativeCell',
    'kb_service/utils',
], function (KBWidget, bootstrap, $, _, Config, Viewers, kbaseNarrativeCell, ServiceUtils) {
    'use strict';
    ...
    return KBWidget({
        ...
        showMetadata: function ($elem) {
            ...
            try {
                ...
                var $g_rfrom = $("<div class='kb-data-obj-graph-ref-from'>").append(
                    '<table><thead><tr><th>Referencing Objects</th></tr></thead><tbody>'
                );
                var $g_rto = $("<div class='kb-data-obj-graph-ref-to'>").append(
