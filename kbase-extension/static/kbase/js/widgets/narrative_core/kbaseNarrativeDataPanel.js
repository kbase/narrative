...
define([
    ...
    return KBWidget({
        ...
        */
        ...
        getSetMembers: function(set_id) {
            return mock_getSetMembers(set_id);
        },

        mock_getSetMembers: function(set_id) {
            var objs = [];
            for (var i=0; i < 100; i++) {
                var x =  [i + 2, 'foo-member-' + i, 'PairedEndLibrary',
                          '20100906', 1, 'dangunter', ws_id, 'FooWorkspace',
        ...
        mock_ws_list_objects: function(ws_id) {
            var objs = [];
            for (var i=0; i < 100; i++) {
                var x =  [i + 2, 'foo-member-' + i, 'PairedEndLibrary',
                          '20100906', 1, 'dangunter', ws_id, 'FooWorkspace',
            ...
            objs.append(                [
                    1, 'foo', 'PairedEndLibrarySet', '20100906',
