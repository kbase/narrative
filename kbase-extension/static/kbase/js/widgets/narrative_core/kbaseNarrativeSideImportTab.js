    ...
    return KBWidget({
        ...
        render: function () {
            ...
            $nextButton.click(
                $.proxy(function (event) {
                    ...
                    self.getMethodSpecs(
                        function (methodFullInfo, methods, tag) {
        ...
        getMethodSpecs: function (callback, errorCallback) {
            ...
            self.methClient.list_method_ids_and_names(
                ...
                function (methodIdToName) {
                    ...
                    $.when(prom1, prom2)
                        .done(function (fullInfoList, specs) {
        ...
        showTab: function (
            ...
            if (numberOfTabs == 1) {
                ...
                var tabHeader = $('<div>').addClass('kb-side-header');
        ...
        runImport: function (methods, tag) {
            ...
            var pythonCode = PythonInterop.buildAppRunner(
                null,
                null,
