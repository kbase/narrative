    ...
    return KBWidget({
        ...
        */
        ...
        showNextSteps: function (obj) {
            ...
            var $unhide_btn = $('<span>').addClass('kb-app-next-unhide').text('next steps').hide();
        ...
        showCellProgress: function (cell, name, done, total) {
            ...
            var $progressBar = $(cell.element).find(
