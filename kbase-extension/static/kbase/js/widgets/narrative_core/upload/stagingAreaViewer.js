define([
  ...
  return new KBWidget({
    ...
    renderFileHeader: function () {
      ...
      this.$elem.append(
        this.ftpFileHeaderTmpl({
          globusUrl:
            uploadConfig.globus_upload_url +
            "&destination_path=" +
            this.userInfo.user,
        ...
        rowCallback: function (row) {
          ...
          $("td:eq(1)", row)
            ...
            .on("click", (e) => {
              ...
              stagingAreaViewer.updatePathFn(
                (this.path += "/" + $(e.currentTarget).data().name)
              );
            });
          ...
          if (fileName && stagingAreaViewer.openFileInfo[fileName]) {
            ...
            setTimeout(() => {
              $caret
                .parent()
                .parent()
                .after(stagingAreaViewer.renderMoreFileInfo(myFile));
            }, 0);
          }
          ...
          $("td:eq(5)", row)
            ...
            .on("click", (e) => {
              ...
              const importFile = getFileFromName(
    ...
    renderMoreFileInfo: function (fileData) {
      ...
      this.stagingServiceClient
        ...
        .then(function (dataString, status, xhr) {
          ...
          var $upaField = $.jqElem("span").append(
    ...
    initImport: function () {
      ...
      $("input.kb-staging-table-body__checkbox-input:checked").each(
        function () {
    ...
    initImportApp: function (type, file) {
      ...
      if (appInfo) {
        ...
        if (
          appInfo.app_input_param_type &&
          appInfo.app_input_param_type === "list"
        ) {
          fileParam = [fileParam];
        }
