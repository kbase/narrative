...
define(['kbwidget', 'bootstrap', 'jquery', 'd3', 'kbaseVisWidget'], function (
    KBWidget,
    bootstrap,
    $,
    d3,
    ...
    return KBWidget({
        ...
        renderChart: function () {
            ...
            var scale = d3.scale.linear().domain(regionDomain).range([0, bounds.size.width]);
            ...
            var regionSelection = regionsSelection
                .selectAll('.region')
