...
define(['kbwidget', 'bootstrap', 'jquery', 'd3', 'kbasePiechart'], (
    KBWidget,
    bootstrap,
    $,
    d3,
    ...
    return KBWidget({
        ...
        options: {
            ...
            colorScale: function (idx, data, $pie) {
                if ($pie.colorScale == undefined) {
                    const domain = [0, 1];
                    const range = [
                        $pie.options.gbgColor || $pie.options.pieColor,
                        $pie.options.gfgColor,
                    ];
                    ...
                    $pie.colorScale = d3.scale.linear().domain(domain).range(range);
                }
        ...
        setDatasets: function (newDatasets) {
            ...
            const sd = function () {
                ...
                $me.options.innerRadius =
                    0 - ($me.outerRadius() - $me.originalInnerRadius) / newDatasets.length;
            ...
            return function () {
                this.on('mouseover', function (d) {
                    ...
                    .on('mouseout', function (d) {
                        ...
                        d3.select(this).attr('fill', (d2, idx) => {
