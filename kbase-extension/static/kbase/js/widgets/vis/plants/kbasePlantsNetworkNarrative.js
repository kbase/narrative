...
define([
    ...
    'kbaseForcedNetwork',
    'kbaseTable',
], (KBWidget, bootstrap, $, kbasePlantsNetworkTable, kbaseForcedNetwork, kbaseTable) => {
    return KBWidget({
        ...
        setInput: function (newInput) {
            ...
            const records = {};
            const datasets = [];
            $.each(newInput.datasets, (idx, rec) => {
