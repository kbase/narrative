require.config({
    ...
    paths: {
        ...
        'datatables.net-select': 'ext_components/datatables.net-select/js/dataTables.select.min',
        'datatables.net-select-bs': 'ext_components/datatables.net-select-bs/js/select.bootstrap.min',
