...
.attr('id','fileInput')
.css('display','none')
.bind('change',$.proxy(this.handleFileSelect,this)))},sessionId:function(){if(this.$terminal!=undefined){return this.$terminal.sessionId;}
else if(this.$loginbox!=undefined){return this.$loginbox.sessionId();}
else{return undefined;}},refreshDirectory:function(path){if(this.sessionId()==undefined){this.data('ul-nav').empty();return;}
