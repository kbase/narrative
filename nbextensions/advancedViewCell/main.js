...
define([
    ...
    function upgradeToViewCell(cell, appSpec, appTag) {
        return Promise.try(function () {
            ...
            .then(function () {
                ...
                utils.setCellMeta(
                    cell,
                    'kbase.viewCell.params',
                    spec.makeDefaultedModel()
                );
            })
            .then(function () {
        ...
        cell.minimize = function () {
            var inputArea = this.input.find('.input_area'),
                ...
                viewInputArea = this.element.find(
                    '[data-subarea-type="view-cell-input"]'
                ),
    ...
    function setupNotebook() {
        return Promise.all(
            jupyter.getCells().map(function (cell) {
                return setupCell(cell);
            })
        );
    }
    ...
    function initializeExtension() {
        ...
        setupWorkspace(runtime.config('services.workspace.url'))
            ...
            .then(function () {
                ...
                jupyter.onEvent('insertedAtIndex.Cell', function (
                    event,
                    payload
                ) {
