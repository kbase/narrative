    ...
    function factory(config) {
        ...
        function specializeCell() {
            cell.minimize = function () {
                var inputArea = this.input.find('.input_area').get(0),
                    ...
                    viewInputArea = this.element.find(
                        '[data-subarea-type="app-cell-input"]'
                    ),
            ...
            cell.renderIcon = function () {
                var iconNode = this.element[0].querySelector(
            ...
            return Promise.try(function () {
                ...
                var dom = Dom.make({ node: cell.input[0] }),
                    kbaseNode = dom.createNode(
                        div({ dataSubareaType: 'app-cell-input' })
                    );
                ...
                cell.input[0].parentNode.insertBefore(
                    kbaseNode,
                    cell.input[0].nextSibling
                );
