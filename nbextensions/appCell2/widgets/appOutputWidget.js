define([
    ...
    function factory(config) {
        var runtime = Runtime.make(),
            bus = runtime
                .bus()
                .makeChannelBus({ description: 'Output Widget Bus' }),
        ...
        function findCellForId(id) {
            var matchingCells = Jupyter.notebook
                .get_cells()
        ...
        function doRemoveOutputCell(index) {
            ...
            ui.showConfirmDialog({
                title: 'Confirm Deletion of Cell Output',
                body: content,
                ...
                content = model.outputs
                    ...
                    .map(function (output, index) {
                        ...
                        if (
                            ...
                            message =
                                'This is the most recent output for this app.';
                        }
                        return div({ class: 'row', style: rowStyle }, [
                            div({ class: 'col-md-8' }, [
                                table({ class: 'table table-striped' }, [
                                    ...
                                    tr([
                                        th('Created'),
                                        td(output.createdTime.toISOString()),
                                    ]),
                                ]),
                            ]),
                            div(
        ...
        function importModel(outputs) {
            var output;
            if (outputs.byJob) {
                model.outputs = Object.keys(outputs.byJob).map(function (
                    jobId
                ) {
