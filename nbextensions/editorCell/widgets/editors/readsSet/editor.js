define([
    ...
    function factory(config) {
        ...
        function doDeleteCell() {
            ...
            ui.showConfirmDialog({ title: 'Confirm Cell Deletion', body: content }).then(function (
                confirmed
            ) {
                if (!confirmed) {
                    return;
        ...
        function loadData(objectRef) {
            ...
            return setApiClient.callFunc('get_reads_set_v1', [params]).spread(function (setObject) {
        ...
        function start(arg) {
            ...
            return loadSpec()
                ...
                .then(function () {
                    ...
                    var appRef = [editorState.getItem('app').id, editorState.getItem('app').tag]
                        .filter(toBoolean)
                        .join('/');
