...
define(['kb_common/props', 'kb_service/client/narrativeMethodStore'], function (
    Props,
    ...
    function factory(config) {
            ...
            var appSpec = {
                parameters: [
                    ...
                    },
                    {
                        ...
                        short_hint:
                            'The description of the set of sequence reads',
                        default_values: [''],
                        optional: 1,
                        disabled: 0,
                        advanced: 0,
        ...
        function createModelForApp(appId, appTag) {
            fetchAppSpec(appId, appTag).then(function () {
         ...
         */
        function start() {
            return fetchAppSpec(appId, appTag).then(function (appSpec) {
                return true;
            });
        }
