define([
    ...
    'common/html',
    'common/jupyter',
], function (Runtime, BusEventManager, Props, UI, html, JupyterInterop) {
    'use strict';
    ...
    function factory(config) {
        var cell = config.cell,
            ...
            bus = runtime
                .bus()
                .makeChannelBus({ description: 'output cell bus' }),
        ...
        function doDeleteCell() {
            var parentCellId = Props.getDataItem(
                cell.metadata,
                'kbase.outputCell.parentCellId'
            );
            var content = div([
                p([
            ...
            ui.showConfirmDialog({
                ...
                runtime.bus().send(
                    {
                        jobId: Props.getDataItem(
                            cell.metadata,
                            'kbase.outputCell.jobId'
                        ),
                        outputCellId: Props.getDataItem(
                            cell.metadata,
                            'kbase.attributes.id'
                        ),
                    },
