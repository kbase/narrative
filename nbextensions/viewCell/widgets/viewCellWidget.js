define([
    ...
    function factory(config) {
        ...
        function loadInputParamsWidget() {
            pRequire('nbextensions/viewCell/widgets/appParamsWidget').then(function (Widget) {
                var bus = runtime
                    .bus()
        ...
        function loadViewParamsWidget() {
            pRequire('nbextensions/viewCell/widgets/appParamsViewWidget').then(function (Widget) {
                var bus = runtime
                    .bus()
                    .makeChannelBus({ description: 'Parent comm bus for input widget' });
