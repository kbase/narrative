   ...
   There are some dependencies for the modules in this directory. Please make sure they are in your environment before trying to run the notebooks.
...
MG-RAST_Retina
   Retina/STM are packages to support a widget framework that Folker's group has
developed
...
> dependencies()
   ...
   Here's an explanation of the files found in this directory

KBNB	         - this is a KBase version of the IPython Notebook. Includes Travis' module for a Shock notebook manager
