...
class ProteinInfo:
    ...
    def fids_to_operons(self, fids):

        arg_hash = { 'method': 'ProteinInfo.fids_to_operons',
                     'params': [fids],
                     'version': '1.1',
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def fids_to_domains(self, fids):

        arg_hash = { 'method': 'ProteinInfo.fids_to_domains',
                     'params': [fids],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def domains_to_fids(self, domain_ids):

        arg_hash = { 'method': 'ProteinInfo.domains_to_fids',
                     'params': [domain_ids],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def fids_to_ipr(self, fids):

        arg_hash = { 'method': 'ProteinInfo.fids_to_ipr',
                     'params': [fids],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def fids_to_orthologs(self, fids):

        arg_hash = { 'method': 'ProteinInfo.fids_to_orthologs',
                     'params': [fids],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def fids_to_ec(self, fids):

        arg_hash = { 'method': 'ProteinInfo.fids_to_ec',
                     'params': [fids],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def fids_to_go(self, fids):

        arg_hash = { 'method': 'ProteinInfo.fids_to_go',
                     'params': [fids],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def fid_to_neighbors(self, id, thresh):

        arg_hash = { 'method': 'ProteinInfo.fid_to_neighbors',
                     'params': [id, thresh],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def fidlist_to_neighbors(self, fids, thresh):

        arg_hash = { 'method': 'ProteinInfo.fidlist_to_neighbors',
                     'params': [fids, thresh],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
