...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_alignment(self, alignment_id, options):
        ...
        arg_hash = { 'method': 'Tree.get_alignment',
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_tree_data(self, tree_ids):
        ...
        arg_hash = { 'method': 'Tree.get_tree_data',
                     'params': [tree_ids],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_alignment_data(self, alignment_ids):
        ...
        arg_hash = { 'method': 'Tree.get_alignment_data',
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_tree_ids_by_source_id_pattern(self, pattern):
        ...
        arg_hash = { 'method': 'Tree.get_tree_ids_by_source_id_pattern',
                     'params': [pattern],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_leaf_to_protein_map(self, tree_id):
        ...
        arg_hash = { 'method': 'Tree.get_leaf_to_protein_map',
                     'params': [tree_id],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_leaf_to_feature_map(self, tree_id):
        ...
        arg_hash = { 'method': 'Tree.get_leaf_to_feature_map',
                     'params': [tree_id],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def compute_abundance_profile(self, abundance_params):
        ...
        arg_hash = { 'method': 'Tree.compute_abundance_profile',
