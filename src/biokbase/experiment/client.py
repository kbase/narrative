...
class Experiment:
    ...
    def __init__(self, url = None, timeout = 30 * 60, user_id = None, 
        ...
        if url is None:
            url = 'http://kbase.us/services/experiment';
        if url is None:
    ...
    def getChildCompounds(self, parents):

        arg_hash = { 'method': 'Experiment.getChildCompounds',
                     'params': [parents],
                     'version': '1.1',
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def getParentCompounds(self, children):

        arg_hash = { 'method': 'Experiment.getParentCompounds',
                     'params': [children],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def getChildAndIntermediateCompounds(self, parents):

        arg_hash = { 'method': 'Experiment.getChildAndIntermediateCompounds',
                     'params': [parents],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def getParentAndIntermediateCompounds(self, children):

        arg_hash = { 'method': 'Experiment.getParentAndIntermediateCompounds',
                     'params': [children],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def findMedias(self, exclude_medias, exclude_compounds, exclude_solid, exclude_undefined):

        arg_hash = { 'method': 'Experiment.findMedias',
                     'params': [exclude_medias, exclude_compounds, exclude_solid, exclude_undefined],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def getEnvironmentsInExchangeFormat(self, environments):

        arg_hash = { 'method': 'Experiment.getEnvironmentsInExchangeFormat',
                     'params': [environments],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def getEnvironmentByGroup(self, groups):

        arg_hash = { 'method': 'Experiment.getEnvironmentByGroup',
                     'params': [groups],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def findStrainsAndKOs(self, genome_id, maxKnockouts, onlyWildtype, onlyAggregate):

        arg_hash = { 'method': 'Experiment.findStrainsAndKOs',
                     'params': [genome_id, maxKnockouts, onlyWildtype, onlyAggregate],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def generateGrowmatchInput(self, gmInputParams):

        arg_hash = { 'method': 'Experiment.generateGrowmatchInput',
                     'params': [gmInputParams],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def storeGrowmatchInput(self, gmInputParams, workspace_id, object_id):

        arg_hash = { 'method': 'Experiment.storeGrowmatchInput',
                     'params': [gmInputParams, workspace_id, object_id],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
