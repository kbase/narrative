...
def main():
    ...
    #auth = Token(aconf)
    token = 'un=kbasetest|tokenid=2567ebbe-2780-11e3-8409-1231391ccf32|expiry=1411827708|client_id=kbasetest|token_type=Bearer|SigningSubject=https://nexus.api.globusonline.org/goauth/keys/26000b42-2780-11e3-8409-1231391ccf32|sig=';
    ...
    sample = ""
    sample_id = 0
    sids = sorted([i for i in lsamples['data'] if not i.startswith('_')])
