...
class BatchTestCase(unittest.TestCase):
    ...
    def test_get_input_scaffold_bad_tag(self):
        ...
        self.assertIn(
            "Can't find tag bar - allowed tags are release, beta, dev", str(e.exception)
        )
    ...
    def test_generate_input_batch(self):
        ...
        for b in input_batch:
            ...
            self.assertIn(
                ...
                inputs["palindrome_clip_threshold"],
            )
    ...
    def test__prepare_output_vals(self):
        ...
        self.assertIn(
            "The output parameter output must have 5 values if it's a list",
            str(e.exception),
        )
        ...
        self.assertIn(
            'No output template provided for parameter "output" and no default value found!',
            str(e.exception),
        )
        ...
        self.assertIn(
            "Output template field not_a_param doesn't match a parameter id or 'run_number'",
            str(e.exception),
        )
