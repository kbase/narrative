...
class NarrativeMethodStore(object):
    ...
    def list_categories(self, params):
        resp = self._call("NarrativeMethodStore.list_categories", [params])
        return resp

    def get_category(self, params):
        resp = self._call("NarrativeMethodStore.get_category", [params])
        return resp[0]

    def list_methods(self, params):
        resp = self._call("NarrativeMethodStore.list_methods", [params])
        return resp[0]

    def list_methods_full_info(self, params):
        resp = self._call("NarrativeMethodStore.list_methods_full_info", [params])
        return resp[0]

    def list_methods_spec(self, params):
        resp = self._call("NarrativeMethodStore.list_methods_spec", [params])
        return resp[0]

    def list_method_ids_and_names(self, params):
        resp = self._call("NarrativeMethodStore.list_method_ids_and_names", [params])
        return resp[0]

    def list_apps(self, params):
        resp = self._call("NarrativeMethodStore.list_apps", [params])
        return resp[0]

    def list_apps_full_info(self, params):
        resp = self._call("NarrativeMethodStore.list_apps_full_info", [params])
        return resp[0]

    def list_apps_spec(self, params):
        resp = self._call("NarrativeMethodStore.list_apps_spec", [params])
        return resp[0]
    ...
    def list_types(self, params):
        resp = self._call("NarrativeMethodStore.list_types", [params])
        return resp[0]

    def get_method_brief_info(self, params):
        resp = self._call("NarrativeMethodStore.get_method_brief_info", [params])
        return resp[0]

    def get_method_full_info(self, params):
        resp = self._call("NarrativeMethodStore.get_method_full_info", [params])
        return resp[0]

    def get_method_spec(self, params):
        resp = self._call("NarrativeMethodStore.get_method_spec", [params])
        return resp[0]

    def get_app_brief_info(self, params):
        resp = self._call("NarrativeMethodStore.get_app_brief_info", [params])
        return resp[0]

    def get_app_full_info(self, params):
        resp = self._call("NarrativeMethodStore.get_app_full_info", [params])
        return resp[0]

    def get_app_spec(self, params):
        resp = self._call("NarrativeMethodStore.get_app_spec", [params])
        return resp[0]

    def get_type_info(self, params):
        resp = self._call("NarrativeMethodStore.get_type_info", [params])
        return resp[0]

    def validate_method(self, params):
        resp = self._call("NarrativeMethodStore.validate_method", [params])
        return resp[0]

    def validate_app(self, params):
        resp = self._call("NarrativeMethodStore.validate_app", [params])
        return resp[0]

    def validate_type(self, params):
        resp = self._call("NarrativeMethodStore.validate_type", [params])
        return resp[0]

    def load_widget_java_script(self, params):
        resp = self._call("NarrativeMethodStore.load_widget_java_script", [params])
        return resp[0]

    def register_repo(self, params):
        self._call("NarrativeMethodStore.register_repo", [params])

    def disable_repo(self, params):
        self._call("NarrativeMethodStore.disable_repo", [params])

    def enable_repo(self, params):
        self._call("NarrativeMethodStore.enable_repo", [params])

    def push_repo_to_tag(self, params):
        self._call("NarrativeMethodStore.push_repo_to_tag", [params])
