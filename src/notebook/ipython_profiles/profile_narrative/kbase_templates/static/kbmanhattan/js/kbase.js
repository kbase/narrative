    ...
    $.KBWidget({
        ...
        render: function() {
            ...
            $.when(fetchAjax).done(function(result) {
                ...
                KBVis.require([ "renderers/network", "util/viewport" ], function(Network, Viewport) {
    ...
    $.KBWidget({
        ...
        addNewCard: function(cardName, options, position) {
            ...
            var newCard = $("#" + newCardId).LandingPageCard({
                position: position,
                title: "<div>" + cardTitle + "</div>" + "<div style='font-size: 14px; font-weight: normal'>" + cardSubtitle + "<span class='label label-primary pull-right'>" + cardWorkspace + "</span></div>",
                width: cardWidth,
                id: newCardId
            });
...
function WSHandler(params) {
    ...
    var url = params && params.url ? params.url : "http://140.221.84.209:7058/";
