...
setup(
    ...
    version="0.0.1",
    install_requires=[s.strip() for s in open("requirements.txt")] + ["doekbase_data_api"],
    dependency_links=["git+https://github.com/kbase/data_api/@develop#egg=doekbase_data_api"],
    extras_require={},
    package_data={"": ["*.json"]},
