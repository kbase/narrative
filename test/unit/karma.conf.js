...
module.exports = function (config) {
    ...
    config.set({
        ...
        files: [
            ...
            // {pattern: 'test/unit/spec/common/cellComponents/filePathWidget-Spec.js', included: false},
            {pattern: 'test/unit/spec/common/cellComponents/**/*.js', included: false},
            {pattern: 'node_modules/jasmine-ajax/lib/mock-ajax.js', included: true},
            {pattern: 'kbase-extension/static/ext_components/font-awesome/**/*', included: false, served: true},
