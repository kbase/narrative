define([
...
], (React, ReactDOM, domUtils, AssemblySetViewer, case1Props, case2Props, case3Props, case4Props, case3Expected, case4Expected) => {
    'use strict';
    ...
    describe('The AssemblySetViewer component', () => {
        ...
        it('should render an assembly set in a "loaded" async status', async () => {
            ...
            const el = createElement(AssemblySetViewer, case4Props, null);
            render(el, node);
