    ...
    describe('The bulk import cell module', () => {
        ...
        describe('construction', () => {
            ...
            describe('xsv specific setup', () => {
                ...
                // it('should build a bulk import cell with appParameters premade info', () => {
                //     const inputs = TestUtil.JSONcopy(testInputs);
                //     inputs.dataType.appParameters.push(appParams1);
                //     const cell = Mocks.buildMockCell('code');
                //     const cellWidget = BulkImportCell.make({
                //         cell,
                //         importData: testInputs,
                ...
                //     expect(cell.metadata.kbase.bulkImportCell.params.dataType.filePaths).toEqual([
                //         {
                //             staging_file_subdir_path: inFileName1,
                //             assembly_name: objName1,
                //         },
                //     ]);
                ...
                //         min_contig_length: 1000,
                //     });
                //     // expect no warning messages
                //     expect(cell.metadata.kbase.bulkImportCell.inputs.dataType.messages).not.toBeDefined();
                // });

                // it('should build a bulk import cell with appParameters premade info, multi-row, no warnings', () => {
                //     const inputs = TestUtil.JSONcopy(testInputs);
                //     inputs.dataType.appParameters.push(appParams1);

                //     const inFileName1 = 'dvh.fasta',
                //         inFileName2 = 'dvh2.fasta',
                //         objName1 = 'dvh_assembly',
                //         objName2 = 'dvh2_assembly',
                //         testInputs = {
                //             dataType: {
                //                 files: [],
                //                 appId: 'simpleApp',
                ...
                //                     },
                //                     {
                //                         staging_file_subdir_path: inFileName2,
                //                         assembly_name: objName2,
                //                         type: ''
                //                     }
                //                 ],
                //             },
